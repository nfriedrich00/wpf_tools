...
class AnalyzerNode(Node):
    ...
    def analyze_data(self):
        ...
        print(f'average_speed_real: {average_speed["average_speed_real"]}')
        print(f'average_speed_assumed: {average_speed["average_speed_assumed"]}')
        ...
        max_error_loc_simpl = get_max_dist_simpl(points = localization_points,
                                                 reference_points = ground_truth_points)
        avg_error_loc = get_avg_distance(inaccurate_poses = localization_poses,
                                         reference_poses = ground_truth_poses)
        avg_error_loc_simpl = get_avg_dist_simpl(inaccurate_points = localization_points,
                                                 reference_points = ground_truth_points)
        
        max_error_real = get_max_dist_simpl(points = ground_truth_points,
                                            reference_points = path_points)
        avg_error_real = get_avg_dist_simpl(inaccurate_points = ground_truth_points,
                                            reference_points = path_points)
        
        max_error_contr = get_max_dist_simpl(points = localization_points,
                                             reference_points = path_points)
        avg_error_contr = get_avg_dist_simpl(inaccurate_points = localization_points,
                                             reference_points = path_points)
